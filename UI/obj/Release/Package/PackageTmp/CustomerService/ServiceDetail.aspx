<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceDetail.aspx.cs" Inherits="UI.CustomerService.ServiceDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("input[type=image][name1]").live("click", function () {
                ...
                var rt = window.showModalDialog("ServiceDetailDialog.aspx?data=" + Math.random(), cs, "dialogWidth:550px;dialogHeight:400px;help:no");
            });
        ...
        function GetData() {
            ...
            myAjax("/Service/CTSerServices.asmx/GetServicesAll4", JSON.stringify({"json":jsstr}) , function (data) {
                ...
                $(rel["list"]).each(function (k, v) {
                    ...
                    var td8 = $("<th><input type='image' src='../images/bt_detail.gif' name1='" + v["UserName"] + "'  name2='" + v["UserName2"] + "' key='" + v["CSID"] + "'  cusid='" + v["CusID"] + "'  desc='" + v["CSDesc"] + "'  deal='" + v["CSDeal"] + "'   CSDealDate='" + v["CSDealDate"] + "'  result='" + v["CSResult"] + "'  sati='" + v["CSSatisfy"] + "'/></th>");
                    $(tr).append(td1)
                    .append(td2)
                    .append(td3)
                    .append(td4)
...
<table class="tableEdit" style="width:600px">
        <tr>
            ...
            <td>
                <select  style="width:80px" id="STID" onchange="change()">
