<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceDetailDialog.aspx.cs" Inherits="UI.CustomerService.ServiceDetailDialog" %>
    ...
    <script>
        $(function () {
            ...
            if (pdata != null) {
                ...
                $("#CSResult").text(pdata["CSResult"]);
                var CSSatisfy = pdata["CSSatisfy"];
                var stxx = "★";
                for (var i = 0; i < CSSatisfy-1; i++) {
                    stxx = stxx + "★";
                }
                $("#CSSatisfy").text(stxx);
            }
 ...
 <table class="tableEdit" style="width:500px;">
    ...
    <table class="tableEdit" style="width:500px;">
        ...
        <tr>
            <th>处理结果：</th>
            <td>
                <span id="CSResult"></span>
             </td>
            <th>满意度：</th>
            <td>
                <span id="CSSatisfy" style="color:red;"></span>
            </td>
        </tr>
        <tfoot>
            <tr>
